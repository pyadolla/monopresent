...
// const animationQueue = new WeakMap<SVGSVGElement, Promise<void>>()
...
//   setSvgData: (data: SVGData) => void = () => undefined
// ): Promise<any[]> {
//   // Setup queue for this svgEl
//   const prev = animationQueue.get(svgEl) ?? Promise.resolve()
//   let resolveCurrent: () => void
//   const current = new Promise<void>((res) => (resolveCurrent = res))
//   animationQueue.set(svgEl, prev.then(() => current))
...
//             return true
//           } else {
//             await gsap.to(element, { duration: TIMING, opacity: 0 })
//             element?.remove()
//             return true
//           }
//         }
...
//             return true
//           } else {
//             await gsap.to(path, { duration: TIMING, opacity: 1 })
//             return true
//           }
//         }
